...
def load_urls_from_files(file_path: str):
    try:
        ...
        print('The file at ' + file_path + ' could not be found.')
        exit(2)
        # The exit code 2 indicates that a return value could not be generated or
...
# page_contents is a string that contains HTML from the pages that the application has read.
